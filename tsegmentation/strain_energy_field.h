...
double StrainEnergyField(Mat3_t S, double nu);//Calculate the strain energy field given a Stress Tensor matrix
...
inline Array<Mat3_t> StressTensor(Array<DEM::Interacton*> Interactons, size_t n_p){
  ...
  for(size_t i=0; i<n_interacton;i++){
    ...
    Vec3_t r1 = (I->P1->x - I->P2->x)/(2*I->P1->Props.V); //Position between the two particles
    //Particle i1, sum the dyadic product F X r1
    S[I->I1](0,0) += I->F1(0)*r1(0); S[I->I1](0,1) += I->F1(0)*r1(1); S[I->I1](0,2) += I->F1(0)*r1(2);
    S[I->I1](1,0) += I->F1(1)*r1(0); S[I->I1](1,1) += I->F1(1)*r1(1); S[I->I1](1,2) += I->F1(1)*r1(2);
    S[I->I1](2,0) += I->F1(2)*r1(0); S[I->I1](2,1) += I->F1(2)*r1(1); S[I->I1](2,2) += I->F1(2)*r1(2);
    //Particle i2, sum the dyadic product F x r2
    Vec3_t r2 = (I->P2->x - I->P1->x)/(2*I->P2->Props.V); //Position between the two particles
    S[I->I2](0,0) += I->F2(0)*r2(0); S[I->I2](0,1) += I->F2(0)*r2(1); S[I->I2](0,2) += I->F2(0)*r2(2);
    S[I->I2](1,0) += I->F2(1)*r2(0); S[I->I2](1,1) += I->F2(1)*r2(1); S[I->I2](1,2) += I->F2(1)*r2(2);
    S[I->I2](2,0) += I->F2(2)*r2(0); S[I->I2](2,1) += I->F2(2)*r2(1); S[I->I2](2,2) += I->F2(2)*r2(2);
  }
...
inline double StrainEnergyField(Mat3_t S, double nu){
  /*
