...
int main(int argc, char **argv) try
{
    ...
    ///XXX Make sure to close the file we so don't incurr in IO incidents
    infile.close();
    ...
    //Up to this point only the block exists. Add cylinders on top and below for flexion test
    //Measure the size of the system
    Vec3_t Xmin_brick,Xmax_brick;
    dom.BoundingBox(Xmin_brick,Xmax_brick);
    std::cout<<"Block minmax :\n\tmin:" <<Xmin_brick <<"\n\tmax:"<< Xmax_brick<<"\n";
    ...
    std::cout<<"Length of the brick: "<<Xmax_brick-Xmin_brick<<std::endl;
